...
class Monolith extends Component {
  ...
  sceneSetup = () => {
    ...
    this.scene.background = new THREE.Color( ColorService.getColor() );
  ...
  addCustomSceneObjects = () => {
    const geometry = new THREE.BoxGeometry(2, 4.5, 0.5);
  ...
  render() {
    return <div style={style} ref={ref => (this.el = ref)}></div>;
  }
}
